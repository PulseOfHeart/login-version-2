...
namespace WindowsFormsApplication1
{
    ...
    public partial class SaveON : Form
    {
       ...
       DataTable dt = new DataTable();
        ...
        {
            InitializeComponent();
            connection.ConnectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Dell\Downloads\update.accdb";
       ...
       // }
        ...
        {
            DialogResult dialog = MessageBox.Show("Are you surely want to log out? ", "Exit", MessageBoxButtons.YesNo);
            if (dialog == DialogResult.Yes)
            {
                this.Hide();
                Login lg = new Login();
                lg.LLogin += new EventHandler(serverlogin_Login);
                lg.Cancel += new EventHandler(serverlogin_Cancel);
        ...
        private void button7_Click_1(object sender, EventArgs e)
        {
           ...
           // String a5 = "";
            ...
            if (comboBox2.SelectedIndex >= 0)
                a1 = comboBox2.Items[comboBox2.SelectedIndex].ToString();

            if (comboBox3.SelectedIndex >= 0)
                a1 = comboBox3.Items[comboBox3.SelectedIndex].ToString();
            ...
            try
            {
                ...
                //command.CommandText = "insert into update values ('" + dateTimePicker1.Value.Date + "', '" +a1+ "', '" +a2+ "', '" + dateTimePicker2.Value.Date + "', '" + dateTimePicker3.Value.Date + "')";
                command.CommandText = "insert into update values ('" + 12/03/2013 + "', '" +"er"+ "', '" +"ert"+ "', '" +23/04/2012+ "', '" +03/05/2015+ "')";
